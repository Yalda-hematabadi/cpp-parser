...
def main():
    ...
    firsts =[]
    for i, var in enumerate(example_grammar):
        firsts.append(ff.compute_first(var))
    if any(set1.intersection(set2) for set1 in firsts for set2 in firsts if set1 != set2):
        print("Error: Grammar has common value in first sets!!")
        sys.exit(1)  
